...
public record PlayerLetterHintsDto(Player Player, List<LetterEvaluation> Correct, List<LetterEvaluation> WrongPosition, List<LetterEvaluation> Wrong, int RoundNumber);